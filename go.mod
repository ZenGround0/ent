...
require (
	...
	github.com/filecoin-project/specs-actors v0.9.11-0.20200924204331-1b7f7d4f5326
	github.com/filecoin-project/specs-actors/v2 v2.0.0-20200920232732-74fe58638031
