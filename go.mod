...
require (
	...
	github.com/filecoin-project/specs-actors v0.9.12-0.20200927154118-1d65899b204a
	github.com/filecoin-project/specs-actors/v2 v2.0.0-20200930190148-f43ae04a6d14
